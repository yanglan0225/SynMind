...
class FrozenCLIPEmbedder(AbstractEmbModel):
    ...
    def __init__(
        ...
        self.tokenizer = CLIPTokenizer.from_pretrained("/home/yl/ssd_new/pretrain_weights/clip-vit-large-patch14")
        self.transformer = CLIPTextModel.from_pretrained("/home/yl/ssd_new/pretrain_weights/clip-vit-large-patch14")
        self.device = device
        self.max_length = max_length
        if freeze:
            self.freeze()
...
# --- 1. 定义模型架构和权重路径 ---
        ckpt_path = "/home/yl/ssd_new/ymh/pretrain_weights/clipG/open_clip_model.safetensors"

# Step 1: 创建模型结构（使用 arch，不加载预训练）
...
class FrozenOpenCLIPEmbedder(AbstractEmbModel):
    ...
    def __init__(
        ...
        super().__init__()
        assert layer in self.LAYERS
        ckpt_path = "/root/autodl-tmp/pretrained_weights/clipG/open_clip_model.safetensors"
